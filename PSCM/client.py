...
class UPRClient:
	...
	def create_user(self, user_id, password, integrity_level, type, 
			is_cooperative, is_infrastructure, is_admin, creator,
	...
	def auth_user(self, user , password):
		...
		r=post(url,data=data)
		return r
	def update_user(self, user_id,  name=None, password=None, integrity=None, type=None, 
		...
		if integrity is not None:
			data['integrity_level']=integrity
